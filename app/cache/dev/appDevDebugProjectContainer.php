...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['assetic.filter.coffee'] = $instance = new \Assetic\Filter\CoffeeScriptFilter('/usr/bin/coffee', 'C:\\Program Files\\nodejs\\\\node.EXE');
    ...
    {
        $this->services['assetic.filter.compass'] = $instance = new \Assetic\Filter\CompassFilter('C:\\Ruby200-x64\\bin\\compass.BAT', 'C:\\Ruby200-x64\\bin\\ruby.EXE');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_cd916550d27aa0c683160dd865640e9464ae7417dec0b5c70272d43970d0d492');
    ...
    {
        return $this->services['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('Y-m-d\\TH:i:sO', 'Africa/Addis_Ababa', true);
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('575975194b1be1.57231462')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'assetic.filter.compass.bin' => 'C:\\Ruby200-x64\\bin\\compass.BAT',
            ...
            'assetic.filter.coffee.node' => 'C:\\Program Files\\nodejs\\\\node.EXE',
